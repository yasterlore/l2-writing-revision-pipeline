...
check_files=$(
  find examples/synthetic tests/fixtures/synthetic/raw_events/valid tests/fixtures/synthetic/safe_views/valid tests/fixtures/synthetic/candidate_sets/valid \
