...
| Artifact writer CLI actual invocation fixtures | static validator implemented | yes, Step498 fixture root | focused tests | no | no | no | contract docs exist | validator implemented; actual invocation not implemented |
...
| `tests/fixtures/learner_state_frozen_policy_generation_artifact_writer_cli_actual_invocation/` | artifact writer CLI actual invocation fixture validation | 32 | 6 / 26 | 192 | 6 | Step500 validator module/CLI and focused tests | not included in Makefile/release-quality yet | metadata-only/body-free sentinel fixtures; no actual invocation correctness claim |
