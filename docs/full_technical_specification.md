...
| `learner_state_frozen_policy_generation_artifact_body_generation_integration_*_v0.1` fixture metadata family | artifact body generation integration fixture root | Step523 fixture root and README | fixture JSON/docs | synthetic metadata-only bridge fixtures; no validator/runtime implementation or artifact body generation integration correctness claim |
...
| `tests/fixtures/learner_state_frozen_policy_generation_artifact_body_generation_integration/` | artifact body generation integration fixture root | 28 | 6 / 22 | 196 | 7 | Step523 fixture root only; validator not implemented | not yet integrated | metadata-only sentinel fixtures connecting runtime summary metadata to artifact body boundary metadata; no artifact body generation integration correctness claim |
