...
For the short public-safe marker that summarizes this milestone status without
raw logs or performance claims, see
[milestone 04 status](status/milestone_04_status.md). For the design, see
