...
- `make check-learner-state-exporter-cli`: standalone exporter CLI smoke target for synthetic valid fixtures; not part of release-quality yet.
- [Learner-state sequence exporter release-quality integration design](learner_state_sequence_exporter_release_quality_integration_design.md): docs-only plan for future wrapper integration of the exporter CLI smoke target.
...
- `make check-learner-state-exporter-cli`: standalone target that exports minimal and past-window synthetic fixtures under `tmp/learner_state_sequence_exporter_smoke/`.
- [Learner-state sequence exporter release-quality integration design](learner_state_sequence_exporter_release_quality_integration_design.md): wrapper position, tmp-output, logging, CI, and risk plan for future exporter CLI release-quality integration.
...
- `make check-learner-state-exporter-cli`: standalone synthetic exporter CLI smoke check; release-quality integration remains a later review.
- [Learner-state sequence exporter release-quality integration design](learner_state_sequence_exporter_release_quality_integration_design.md): docs-only design for future release-quality wrapper integration through the standalone Makefile target.
