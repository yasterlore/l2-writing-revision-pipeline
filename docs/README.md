...
- [Selective prediction and calibration validator CLI design](selective_prediction_calibration_validator_cli_design.md): docs-only CLI mode, exit-code, safe output, and fixture-root matching plan for the calibration fixture validator.
...
- [Selective prediction and calibration validator CLI design](selective_prediction_calibration_validator_cli_design.md): future safe `python -m learner_state.selective_prediction_validation` interface design; no CLI, Makefile target, or release-quality integration is added yet.
