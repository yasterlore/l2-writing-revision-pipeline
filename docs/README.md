...
- [Frozen selective prediction policy fixture design](frozen_selective_prediction_policy_fixture_design.md): docs-only fixture-root and valid/invalid case design for future frozen policy artifact validation; no fixture files are added.
...
- [Frozen selective prediction policy fixture design](frozen_selective_prediction_policy_fixture_design.md): Step221 docs-only design for the future synthetic frozen policy fixture root, expected results, reason codes, and validation checks.
...
- [Frozen selective prediction policy fixture design](frozen_selective_prediction_policy_fixture_design.md): docs-only plan for future valid/invalid frozen policy fixtures; no fixture root is created.
