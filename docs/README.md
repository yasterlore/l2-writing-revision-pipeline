...
- [Selective prediction and calibration validator Makefile target design](selective_prediction_calibration_validator_makefile_target_design.md): docs-only target name, command, safe logging, tmp policy, and release-quality staging plan for the calibration fixture validator CLI.
...
- [Selective prediction and calibration validator Makefile target design](selective_prediction_calibration_validator_makefile_target_design.md): docs-only design for a future standalone `make` smoke target over the synthetic selective prediction fixture root.
