...
Step619 adds the Step617 standalone invalid-case fail-closed target to release-quality. This matrix design remains unchanged; Step619 does not change Makefile, workflow, Python code/tests, fixture JSON, manifest writer integration, or file writing.
