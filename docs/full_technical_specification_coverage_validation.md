...
| artifact body generation integration fixtures | integration root | 11 | fixture root added after Step523 | 28 cases / 196 JSON files; validator/runtime integration not implemented. |
...
| artifact body generation integration fixtures | Step523 fixture root/docs | 7, 11 | fixture root added after Step523 | v0.1 metadata-only schema family and aggregate counts documented; validator/runtime integration remains future work. |
