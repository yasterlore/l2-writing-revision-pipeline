...
| artifact body generation integration fixture root | validator not implemented | `tests/fixtures/learner_state_frozen_policy_generation_artifact_body_generation_integration/` | `learner_state_frozen_policy_generation_artifact_body_generation_integration_*_v0.1` fixture metadata family | none | not yet included |
...
| Artifact body generation integration fixtures | integration case/runtime-summary/request/pointer/generation/expected-summary/error metadata schema names | Step523 fixture root and README |
...
| Artifact body generation integration fixture | none | none | integration fixture root | Step522/Step523 docs and fixture README | none | none | none | Step523 fixture-only metadata boundary; validator/runtime integration not implemented | yes |
