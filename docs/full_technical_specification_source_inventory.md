...
| Artifact writer CLI integration runtime | none observed | none observed | fixture root only | runtime design docs | none | none | none | not implemented | yes, as future work |
