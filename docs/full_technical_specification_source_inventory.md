...
| Artifact writer CLI actual invocation fixture | static validator module | focused validator tests | actual invocation fixture root | actual invocation fixture docs | standalone validator target | none | none | Step502 target implemented; actual invocation not implemented | yes |
