...
wrapper as static validation. The Step491 artifact writer CLI integration
runtime smoke target is standalone only as of this scan and was not observed
in the wrapper.
